...
if ( false !== $field_name_layout ) {
    $show_next_price = isset( $show_next_price ) ? $show_next_price : true;
    ...
    if ( $show_next_price ) {
        woocommerce_wp_checkbox(
            array(
                'id' => $field_name_layout . '_next_prices',
                'value' => $use_new_layout_next_prices ? $use_new_layout_next_prices : 'no',
                'label' => __('Show next 5 prices', 'rpt_wc'),
                'description' => __('This will show the next 5 prices. Applicable for New Layout only.', 'rpt_wc'),
                'cbvalue' => 'yes',
            )
        );
    }

...
= 1.9.1 - 2022-11-18 =
* Fix: Next 5 Prices were never toggled in admin and always shown in front.

= 1.9.0 - 2022-11-16 =
* New: Show 5 next prices when using "New Layout" on Simple Products
* New: Shortcode can be set without specifying product ID. Useful when using Page builders such as Elementor for Page Templates. It will use the current product ID.
* Fix: [Premium] If a product was saved with new bulk timestamps, without intervals set, it would cause an error.
